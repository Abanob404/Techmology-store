...
function injectFloatingSocials() {
    ...
    div.innerHTML = `
        ...
        <a href="https://www.facebook.com/technologystore.official/" target="_blank" class="w-12 h-12 bg-[#1877F2] rounded-full flex items-center justify-center text-white shadow-[0_0_15px_rgba(24,119,242,0.3)] hover:scale-110 transition-transform" aria-label="صفحتنا على فيسبوك" title="صفحتنا على فيسبوك">
