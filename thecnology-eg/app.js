                ...
                <div class="p-3 md:p-5 flex flex-col flex-1">
                    ...
                    <div class="mt-auto pt-3 md:pt-4 flex flex-col gap-2 border-t border-outline-variant/30">
                        ...
                        <div class="grid grid-cols-2 gap-1.5 sm:gap-2">
                            <button onclick="addToCart('${p._id}'); event.stopPropagation();" class="${!isOutOfStock ? 'bg-primary/20 hover:bg-primary/30 border border-primary/30 text-primary' : 'bg-primary/10 border border-primary/10 text-primary/40 pointer-events-none'} rounded h-10 px-2 text-[11px] md:text-xs font-bold transition-all flex items-center justify-center gap-2" title="أضف للسلة">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                                <span class="whitespace-nowrap">أضف للسلة</span>
                            </button>
                            <a href="${whatsappLink}" target="_blank" onclick="event.stopPropagation();" class="${!isOutOfStock ? 'btn-modern-green' : 'btn-modern-green opacity-50 pointer-events-none'} !h-10 !px-2 flex items-center justify-center gap-2 text-[11px] md:text-xs rounded" title="استفسر">
                ...
                <div class="w-full md:w-1/2 p-6 md:p-8 flex flex-col">
                    ...
                    <div class="flex flex-col gap-3 mt-auto pt-4 border-t border-outline-variant/30">
                        <div class="flex gap-3">
                            ...
                            <a id="modalWhatsappBtn" href="#" target="_blank" class="flex-1 rounded-lg text-sm md:text-base font-bold py-3 flex items-center justify-center gap-2 bg-[#00D06C] hover:bg-[#00D06C]/90 text-white transition-all shadow-sm">
